...
1. Images are checked out using **iachkout**
2. Export lists are generated from archive queries
3. **iaexport** displays image information and status
4. Modified images are checked back in using **iachkin**
